...
if (isset($_POST['submit'])) {
    $tmp = Users::authenticate($_POST['username'], $_POST['pword']);
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-3 center">
                            <div class="login-box">
                                <a href="index.html" class="logo-name text-lg text-center">E-commerceSystem</a>
                                    <?php $msg = "";if(isset($message)){$msg = $message;}echo output_message($msg); ?>
                                <p class="text-center m-t-md">Please Login to begin.</p>
                                    ...
                                    <a href="forgot.html" class="display-block text-left m-t-md text-sm">Forgot Password?</a>
                                    <a href="register.php" class="display-block text-right m-t-md text-sm">Register</a>
