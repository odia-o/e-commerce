...
if (isset($_POST['submit'])) {
    ...
    $found_user = Admin::authenticate($any, $password);
                            ...
                            <div class="login-box">
                                ...
                                <form class="m-t-md" action="index.html">
                                    <div class="form-group">
                                        <input type="email" name="any" value="<?php if(isset($_POST['any'])){echo $_POST['any'];} ?>" class="form-control" placeholder="Email" required>
                                    </div>
                                    <div class="form-group">
